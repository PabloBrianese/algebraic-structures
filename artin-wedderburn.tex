...
\begin{document}
  ...
  \begin{proof}
    ...
    Para cada \(B\), el conjunto \(S(B)\) tiene un elemento maximal \(B'\) (por el Teorema VIII.1.4).
    ...
    Consecuentemente, cada \(A_k / A_{k + 1}\) es nonulo y no tiene submódulos propios por el Teorema IV.1.10.
