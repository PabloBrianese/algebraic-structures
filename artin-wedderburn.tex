...
\begin{document}
  ...
  \begin{theorem}
    Si \(D\) es un anillo de división y \(R = \Mat_n D\), entonces el ideal \(R E_{i i}\) está formado por todas las matrices \(A \in R\) tales que \(\Col_j A = 0\) \((\forall j \neq i)\).
  ...
  \begin{theorem}
    Si \(D\) es un anillo de división y \(R = \Mat_n D\), entonces el ideal \(E_{i_0 i_0}\) está formado por todas las matrices \(A \in R\) tales que \(\Fila_i A = 0\) \((\forall i \neq i_0)\).
