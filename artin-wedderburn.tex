...
\begin{document}
  ...
  \begin{theorem}\label{theorem:matrixRingIdeals}
  ...
  \begin{proof}
    ...
    Si \(f\) es un elemento de \(\Hom_D(V, V)\), entonces \(f\) está completamente determinado por su acción sobre \(v_1, \dots, v_m\) por los teoremas%~\ref{theorem:freeUnitalModulesOverARingWithIdentity}
